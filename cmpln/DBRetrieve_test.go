...
func TestRetrievePosts(t *testing.T) {
	...
	posts = append(posts, models.Post{Nickname: "test name", Description: "test description", Date: "2024-09-01 23:51:21", Topic: "test"})
	posts = append(posts, models.Post{Nickname: "second name", Description: "second description", Date: "2024-09-01 23:54:59", Topic: "test"})

	tests := []struct {
		name       string
		topic      string
		limit      int
		postsArray []models.Post
	}{
		{
